...
silverware_drawer = Drawer.new
spoon = silverware_drawer.add_item(Silverware.new("spoon"))
raise Exception.new("You don't have a spoon to remove") unless silverware_drawer.contents[0].type.include?("spoon")
